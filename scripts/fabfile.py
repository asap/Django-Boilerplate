"""
Scripts to create and initialize a virtual environment for a Django project
based on the project template found at https://github.com/cbslocal/Django-Boilerplate
"""
...
def projectsetup():
    ...
    with lcd(os.path.join(VIRTUAL_ENV['project_path'], '{{ project_name }}',
